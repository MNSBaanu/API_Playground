...
| `storage.ts` | `localStorage` read/write for collections, environments, active environment, history (size-capped). Includes v1→v2 migration for the flat-request legacy layout |
